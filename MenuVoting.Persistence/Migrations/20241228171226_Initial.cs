        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MenuPools_Restaurants_RestaurantId",
                        column: x => x.RestaurantId,
                        principalTable: "Restaurants",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    Dishes = table.Column<string[]>(type: "text[]", nullable: true),
                    MenuPoolId = table.Column<Guid>(type: "uuid", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Menus", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Menus_MenuPools_MenuPoolId",
                        column: x => x.MenuPoolId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MenuPools_RestaurantId",
                table: "MenuPools",
                column: "RestaurantId");

            migrationBuilder.CreateIndex(
                name: "IX_Menus_MenuPoolId",
                table: "Menus",
                column: "MenuPoolId");
